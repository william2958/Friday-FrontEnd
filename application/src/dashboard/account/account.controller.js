	...
	function AccountController(AuthorizationService, AccountService, $rootScope, $mdDialog) {
		...
		$ctrl.toggleEditAccount = function(account) {
			...
			if ($ctrl.editAccount) {
				...
				if ($ctrl.editAccountForm.website !== $ctrl.account.website || $ctrl.editAccountForm.email !== $ctrl.account.email || $ctrl.editAccountForm.password !== $ctrl.account.password) {
